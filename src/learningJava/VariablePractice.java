...
//		 System.out.println("Value of the bigNumber variable is: "+ bigNumber );
		...
		/* Hi my name is srikant
		 	I am teachin Java Programming Language
		 */
...
//		
//		System.out.println("boolean value: "+ val +" value neg is : " + negVal);
...
//		
//		
//		System.out.println("The short value in the babies variable is: " + babies);
//		System.out.println("The bignumber value in the bigNumber variable is: " + bigNumber);
//		
//		float flotnum = 15.00f; // 4 bytes
//		double doublenum = 20.2d; // 8 bytes
//		
